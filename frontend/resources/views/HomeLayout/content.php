...
<div class="col-md-8">
<form action="https://coodiv.net/whmcs/domainchecker.php" method="post" id="domain-search" class="wow fadeIn" data-wow-delay="0.5s">
<input type="hidden" name="token" value="4df76ebbbb6172a6f510e899b094846c1a7e8156" />
...
<button id="transfer-btn" type="submit" name="transfer" value="Transfer"> <img src="templates/templates-nuhost/img/svgs/transfer.svg" alt="transfer icon" /></button>
</span>
<div class="domain-price-header mr-auto">
<a>
<img src="templates/templates-nuhost/img/domain/com.png" alt="domain" />
<span>$14.99</span>
</a>
<a>
<img src="templates/templates-nuhost/img/domain/net.png" alt="domain" />
 <span>$9.99</span>
</a>
<a>
<img src="templates/templates-nuhost/img/domain/org.png" alt="domain" />
<span>$0.99</span>
</a>
<a class="no-phon-dsply">
<img src="templates/templates-nuhost/img/domain/store.png" alt="domain" />
<span>$8.99</span>
</a>
</div>
</form>
...
<i class="icon flaticon-063-circuit color-1"></i>
<h5> Alan Adı Satın Al</h5>
<p>We have 100's of domains to choose from, not to mention prices that other companies only dream about.</p>
<div class="badje-link-footer"><a href="cart2029.html">see more <i class="far fa-arrow-alt-circle-right"></i> </a></div>
</div>
<div class="col-md-4 item-icons">
<span class="nomber-overlow"><b>02</b></span>
<i class="icon flaticon-063-server color-2"></i>
...
<div class="container">
<div class="tittle-simple-one"><h5>Chose your best pricing plan<span> you want custom hosting plan.<br> No hidden charge. </span></h5></div>
...
<form class="tree-steps-hosting-plans-login-form" method="post" action="https://coodiv.net/whmcs/dologin.php" role="form" data-form="validate">
<input type="hidden" name="token" value="4df76ebbbb6172a6f510e899b094846c1a7e8156" />
<div class="col-md-12 mb-3">
<label for="firstName">E-Posta Adresini Gir</label>
<input type="email" name="username" class="form-control" id="inputEmail" placeholder="E-Posta Adresini Gir" required>
</div>
<div class="col-md-12 mb-3">
<label for="password">Şifre</label>
<input type="password" class="form-control" name="password" id="inputPassword" placeholder="Şifre" required>
</div>
<div class="custom-control custom-checkbox fl-lf-mr-tp-25 ">
<input type="checkbox" class="custom-control-input" id="rememberme">
<label class="custom-control-label" for="rememberme" name="rememberme"><small>Beni hatırla</small></label>
</div>
</div>
...
<button type="submit" class="btn-login-inscrespto">Giriş</button>
</span>
</form>
...
<label class="custom-control-label" for="paypal"><img src="templates/templates-nuhost/img/demo/paypal.png" alt="" /></label>
</div>
<div class="custom-control custom-radio col-md-6 mb-3">
<input id="credit" name="paymentMethod" type="radio" class="custom-control-input" checked required>
<label class="custom-control-label" for="credit"><img src="templates/templates-nuhost/img/demo/card.png" alt="" /></label>
</div>
</div>
<br>
...
<div class="item">
<a href="#"> <img src="templates/templates-nuhost/img/pertners/logo1.png" alt="" /> </a>
</div>
<div class="item">
<a href="#"> <img src="templates/templates-nuhost/img/pertners/logo2.png" alt="" /> </a>
</div>
<div class="item">
<a href="#"> <img src="templates/templates-nuhost/img/pertners/logo3.png" alt="" /> </a>
</div>
<div class="item">
<a href="#"> <img src="templates/templates-nuhost/img/pertners/logo4.png" alt="" /> </a>
</div>
<div class="item">
<a href="#"> <img src="templates/templates-nuhost/img/pertners/logo5.png" alt="" /> </a>
</div>
<div class="item">
<a href="#"> <img src="templates/templates-nuhost/img/pertners/logo1.png" alt="" /> </a>
</div>
...
<section class="perlex-efect-section parallax-window" data-parallax="scroll" data-image-src="/whmcs/templates/templates-nuhost/img/demo/bg.jpg">
<span class="perlex-hidden-iverlow"></span>
<div class="container">
<div class="row justify-content-left custom-row">
<div class="col-md-5">
...
<div class="row justify-content-center">
<div class="col-md-5">
<img src="templates/templates-nuhost/img/demo/server.jpg" alt="" />
</div>
...
<form class="form-domain-home-stwo col-md-10" action="https://coodiv.net/whmcs/domainchecker.php" method="post">
<input type="hidden" name="token" value="4df76ebbbb6172a6f510e899b094846c1a7e8156" />
<div class="row justify-content-left custom-row">
<div class="col-md-9 input-group">
<input style="border-right: 0" id="domain-text" name="domain" type="text" class="form-control input-search-text" required>
...
<img src="templates/templates-nuhost/img/domain/black/com.png" alt="domain">
</a>
<a data-toggle="tooltip" data-placement="bottom" title="$8.99">
<img src="templates/templates-nuhost/img/domain/black/net.png" alt="domain">
</a>
<a data-toggle="tooltip" data-placement="bottom" title="$8.99">
<img src="templates/templates-nuhost/img/domain/black/org.png" alt="domain">
</a>
<a data-toggle="tooltip" data-placement="bottom" title="$8.99" class="no-phon-dsply">
<img src="templates/templates-nuhost/img/domain/black/store.png" alt="domain">
</a>
</div>
</div>
</div>
...
<a href="cart2029.html"><i id="fisrt-domains" data-toggle="tooltip" data-placement="top" title="add to cart" class="far fa-check-circle domain-tci-check"></i></a>
...
<a href="cart2029.html"><i id="second-domains" data-toggle="tooltip" data-placement="top" title="add to cart" class="far fa-check-circle domain-tci-check"></i></a>
...
<a href="cart2029.html"><i id="third-domains" data-toggle="tooltip" data-placement="top" title="add to cart" class="far fa-check-circle domain-tci-check"></i></a>
...
<img src="templates/templates-nuhost/img/svgs/book.svg" alt="" />
</div>
...
<div class="domain-homepage-anouncement-box">
<div class="domain-homepage-anouncement-box-img">
 <img src="templates/templates-nuhost/img/svgs/ring.svg" alt="" />
</div>
<h5>Take control</h5>
...
<div class="domain-homepage-anouncement-box-img">
<img src="templates/templates-nuhost/img/svgs/dollar.svg" alt="" />
</div>
...
<div class="col-md-6">
<h5>brazil</h5>
<p><span>address</span> tchuk slov 133, contral park,brazil</p>
<p><span>phone</span>00213 123-45-67-89 
<br>00213 123-45-67-89</p>
<p><span>email</span> <a href="https://coodiv.net/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="483b3d3838273a3c082b27272c213e66262d3c">[email&#160;protected]</a></p>
</div>
<div class="col-md-6">
<h5>paris</h5>
<p><span>address</span> tchuk slov 133, contral park,brazil</p>
<p><span>phone</span>00213 123-45-67-89 
<br>00213 123-45-67-89</p>
<p><span>email</span> <a href="https://coodiv.net/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="53202623233c212713303c3c373a257d3d3627">[email&#160;protected]</a></p>
</div>
</div>
<div class="col-md-7">
<div class="map-gene-server-place">
<img src="templates/templates-nuhost/img/map/map-world.png" alt="" />
...
<div class="post-thumbn parallax-window" style="background: url(templates/templates-nuhost/img/blog/blog4.png) no-repeat center;"></div>
<div class="post-bodyn">
<h5><a href="#">Up and Running With WooCommerce</a></h5>
<p><i class="far fa-calendar"></i>Mars 02,2018</p>
</div>
</div>
</div>
<div class="col-md-4">
<div class="home-blog-te">
<div class="post-thumbn parallax-window" style="background: url(templates/templates-nuhost/img/blog/blog3.png) no-repeat center;"></div>
<div class="post-bodyn">
<h5><a href="#">Up and Running With WooCommerce</a></h5>
<p><i class="far fa-calendar"></i>Mars 02,2018</p>
</div>
...
<div class="col-md-4">
<div class="home-blog-te">
<div class="post-thumbn parallax-window" style="background: url(templates/templates-nuhost/img/blog/blog2.png) no-repeat center;"></div>
<div class="post-bodyn">
<h5><a href="#">Up and Running With WooCommerce</a></h5>
<p><i class="far fa-calendar"></i>Mars 02,2018</p>
</div>
...
<h5 style="margin-bottom: 0;" class="help-center-title"><span>Duyurular</span></h5>
</div>
</div>
<div class="announcement-single">
<h3 style="margin-top:0">
<a class="title-announcement-single" href="index.php/announcements/1/Thank-you-for-choosing-WHMCS.html">Thank you for choosing WHMCS!</a>
...
<a href="index.php/announcements/1/Thank-you-for-choosing-WHMCS.html" class="label label-warning">Devamını Oku &raquo;</a>
</p>
</blockquote>
</div>
</div>
